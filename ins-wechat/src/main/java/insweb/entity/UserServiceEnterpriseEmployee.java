...
public class UserServiceEnterpriseEmployee {
    private Long id;
    ...
    public Long getEnterpriseRuid() {
        return enterpriseRuid;
    }

    public void setEnterpriseRuid(Long enterpriseRuid) {
        this.enterpriseRuid = enterpriseRuid;
    }
