    ...
    <div class="row">
        <div style="width:280px;margin-left: 15px;" id="panel">
            <div class="input-group" style="float: left;">
                ...
                <input class="form-control date-picker" style="width:100px;z-index: 20;" type="text"
                       data-date-format="yyyy-mm-dd" id="date"
                       value="${StaticFunction.getYesterDay()}"/>
				
				<span class="input-group-addon" id="selectrange">
					<a href="#" id="1" class="sd" style="text-decoration: none;color: black;">昨天</a>
